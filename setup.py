...
Popen(["echo",password,"|","sudo","apt","install","espeak"]).wait()
Popen(["echo",password,"|","sudo","apt","install","alsa"]).wait()
Popen(["echo",password,"|","sudo","apt","install","libasound-dev"]).wait()
Popen(["echo",password,"|","sudo","apt","install","alsa-utils"]).wait()
Popen(["echo",password,"|","sudo","apt","install","python3-pyaudio"]).wait()
